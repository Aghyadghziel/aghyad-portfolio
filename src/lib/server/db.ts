...
export const SCHEMA: string[] = [
  ...
  // Browsers marked "Not me": the same-network rule must never claim them again.
  ...
  // Messages sent from the contact form: stored first, emailed second, so none is lost.
